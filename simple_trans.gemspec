...
require "simple_trans/version"

Gem::Specification.new do |spec|
  spec.name          = "simple_trans"
  spec.version       = SimpleTrans::VERSION
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["changelog_uri"] = "https://github.com/yhk1038/simple_trans/blob/master/CHANGELOG.md"
  else
